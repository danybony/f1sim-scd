...
package body RI.circuit_RI.Helper is
   ...
   package body Internals is
      ...
      circuit_RI_Initialized : PolyORB.Std.Boolean :=
        False;

      ---------------------------
      -- Initialize_circuit_RI --
      ---------------------------

      procedure Initialize_circuit_RI is
      ...
      begin
         if not circuit_RI_Initialized
         then
            circuit_RI_Initialized :=
              True;
            RI.circuit_RI.Helper.TC_circuit_RI :=
   ...
   begin
      RI.circuit_RI.Helper.Internals.Initialize_circuit_RI;
