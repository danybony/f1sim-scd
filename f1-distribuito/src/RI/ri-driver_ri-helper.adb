...
package body RI.driver_RI.Helper is
   ...
   function From_Any (Item : CORBA.Any) return RI.driver_RI.Ref is
   begin
      return To_Ref (CORBA.Object.Helper.From_Any (Item));
   end From_Any;

   function To_Any
     (Item : RI.driver_RI.Ref) return CORBA.Any is
      A : CORBA.Any := CORBA.Object.Helper.To_Any
        (CORBA.Object.Ref (Item));
   begin
      CORBA.Internals.Set_Type (A, TC_driver_RI);
      return A;
   end To_Any;
   ...
   begin
      ...
      declare
         Name : constant CORBA.String := CORBA.To_CORBA_String ("driver_RI");
         Id   : constant CORBA.String := CORBA.To_CORBA_String ("IDL:RI/driver_RI:1.0");
      begin
         TC_driver_RI :=
           CORBA.TypeCode.Internals.To_CORBA_Object (PolyORB.Any.TypeCode.TC_Object);
         CORBA.Internals.Add_Parameter (TC_driver_RI, CORBA.To_Any (Name));
         CORBA.Internals.Add_Parameter (TC_driver_RI, CORBA.To_Any (Id));
         CORBA.TypeCode.Internals.Disable_Reference_Counting (TC_driver_RI);
      end;
