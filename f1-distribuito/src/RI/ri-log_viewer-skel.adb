...
package body RI.Log_viewer.Skel is
   ...
   setEnvironment_Arg_Name_T1_Ü : constant CORBA.Identifier :=
     CORBA.To_CORBA_String
        ("T1");

   setEnvironment_Arg_Name_T2_Ü : constant CORBA.Identifier :=
     CORBA.To_CORBA_String
        ("T2");
      ...
      begin
         ...
         then
            declare
               ...
               Argument_T1_Ü : CORBA.Short;
               pragma Warnings (Off, Argument_T1_Ü);
               Arg_CC_T1_Ü : aliased PolyORB.Any.Content'Class :=
                 CORBA.Wrap
                    (Argument_T1_Ü'Unrestricted_Access);
               Arg_Any_T1_Ü : constant CORBA.Any :=
                 CORBA.Internals.Get_Wrapper_Any
                    (CORBA.TC_Short,
                     Arg_CC_T1_Ü'Unchecked_Access);
               Argument_T2_Ü : CORBA.Short;
               pragma Warnings (Off, Argument_T2_Ü);
               Arg_CC_T2_Ü : aliased PolyORB.Any.Content'Class :=
                 CORBA.Wrap
                    (Argument_T2_Ü'Unrestricted_Access);
               Arg_Any_T2_Ü : constant CORBA.Any :=
                 CORBA.Internals.Get_Wrapper_Any
                    (CORBA.TC_Short,
                     Arg_CC_T2_Ü'Unchecked_Access);
            ...
            begin
               ...
               CORBA.NVList.Add_Item
                 (Argument_List_Ü,
                  setEnvironment_Arg_Name_T1_Ü,
                  Arg_Any_T1_Ü,
                  CORBA.ARG_IN);
               CORBA.NVList.Add_Item
                 (Argument_List_Ü,
                  setEnvironment_Arg_Name_T2_Ü,
                  Arg_Any_T2_Ü,
                  CORBA.ARG_IN);
               CORBA.NVList.Add_Item
                 (Argument_List_Ü,
