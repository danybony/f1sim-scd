...
package body RI.Log_viewer.Helper is
   ...
   function From_Any (Item : CORBA.Any) return RI.Log_viewer.Ref is
   begin
      return To_Ref (CORBA.Object.Helper.From_Any (Item));
   end From_Any;

   function To_Any
     (Item : RI.Log_viewer.Ref) return CORBA.Any is
   ...
   begin
      ...
      declare
         ...
         Id   : constant CORBA.String := CORBA.To_CORBA_String ("IDL:RI/Log_viewer:1.0");
      begin
         TC_Log_viewer :=
