...
package body RI.startup_RI.Helper is
   ...
   function From_Any (Item : CORBA.Any) return RI.startup_RI.Ref is
   begin
      return To_Ref (CORBA.Object.Helper.From_Any (Item));
   end From_Any;

   function To_Any
     (Item : RI.startup_RI.Ref) return CORBA.Any is
      A : CORBA.Any := CORBA.Object.Helper.To_Any
        (CORBA.Object.Ref (Item));
   begin
      CORBA.Internals.Set_Type (A, TC_startup_RI);
      return A;
   end To_Any;
   ...
   begin
      ...
      declare
         Name : constant CORBA.String := CORBA.To_CORBA_String ("startup_RI");
         Id   : constant CORBA.String := CORBA.To_CORBA_String ("IDL:RI/startup_RI:1.0");
      begin
         TC_startup_RI :=
           CORBA.TypeCode.Internals.To_CORBA_Object (PolyORB.Any.TypeCode.TC_Object);
         CORBA.Internals.Add_Parameter (TC_startup_RI, CORBA.To_Any (Name));
         CORBA.Internals.Add_Parameter (TC_startup_RI, CORBA.To_Any (Id));
         CORBA.TypeCode.Internals.Disable_Reference_Counting (TC_startup_RI);
      end;
