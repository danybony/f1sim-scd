...
package body RI.Log_viewer is
   ...
   setEnvironment_Arg_Name_T1_Ü : constant PolyORB.Types.Identifier :=
     PolyORB.Types.To_PolyORB_String
        ("T1");

   setEnvironment_Arg_Name_T2_Ü : constant PolyORB.Types.Identifier :=
     PolyORB.Types.To_PolyORB_String
        ("T2");
